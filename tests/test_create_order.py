...
class TestCreateOrder:
    person_data = [
        ...
        ['Uchiha', 'Uchiha', 'Konoha, 150 apt.', '6', '+7 800 355 35 44', '6', '2020-06-06',
         'Saske, come back to Konoha', "GREY"],
        ['Naruto', 'Naruto', 'Konoha, 163 apt.', '7', '+7 800 355 35 55', '7', '2020-06-06',
         'Saske, come back to Konoha', "BLACK, GREY"],
        ['Uchiha', 'Naruto', 'Konoha, 177 apt.', '8', '+7 800 355 35 59', '8', '2020-06-06',
    ...
    @allure.title('Создаю заказ с цветом')
